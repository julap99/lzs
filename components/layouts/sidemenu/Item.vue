...
function activeMenu(routePath) {
  return route.path == routePath
    ? `bg-[rgb(var(--sidebar-menu))] font-normal text-white active-menu border-l-4 border-[rgb(var(--active-menu-border))]`
    : `font-light text-white/90 md:transition-all md:duration-200 hover:md:ml-2 hover:bg-transparent hover:text-white`;
}
