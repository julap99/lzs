...
const nextPage = () => {
  if (currentPage.value * pageSize.value < dataLength.value) currentPage.value++;
};
const prevPage = () => {
      ...
      >
        <div>
          <div class="flex gap-x-2">
            ...
            >
              <Icon name="ic:outline-filter-alt" class="mr-0 md:mr-1" size="1rem" />
        ...
        >
          <thead
            ...
            :class="{
              ...
              'border-primary/50 bg-primary text-white': options.variant === 'primary',
              'border-secondary/50 bg-secondary text-white':
                options.variant === 'secondary',
              'border-info/50 bg-info text-white ': options.variant === 'info',
              'border-success/50 bg-success text-white': options.variant === 'success',
              'border-warning/50 bg-warning text-white': options.variant === 'warning',
              'border-danger/50 bg-danger text-white': options.variant === 'danger',
            }"
          >
            <tr>
              <th
                ...
                :class="{
                  ...
                  'border-[rgb(var(--border-color))]': options.variant === 'default',
          ...
          <tbody v-else>
            ...
            >
              ...
              <td
                ...
                :key="index2"
              >
                <slot :name="val2" :text="filteredDatabyTitle(val1, val2)" :value="val1">
  ...
  <div v-else class="table-wrapper p-4">
    <div class="border border-[rgb(var(--border-color))] rounded-lg overflow-hidden">
      ...
      <div class="p-8 text-center">
        ...
        <p class="text-[rgb(var(--text-color))] text-lg font-medium">Tiada data</p>
        <p class="text-gray-500 mt-2">Tiada entri untuk dipaparkan pada masa ini.</p>
      </div>
    </div>
  </div>
</template>
