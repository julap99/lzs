      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <p class="text-sm leading-relaxed text-gray-800">
            ...
            Selangor seperti yang dinyatakan di dalam Notis Privasi Zakat
            Selangor di https://www.zakatselangor.com.my. Saya juga telah
            mendapatkan persetujuan daripada pihak ketiga berhubung dengan data
            dan maklumat pihak ketiga yang akan diserahkan kepada pihak Zakat
            Selangor.
          </p>
          <div class="mt-4">
        ...
        <!-- Income Confirmation Consent -->
        <div
          class="bg-blue-50 border border-blue-200 rounded-lg p-4 h-full flex flex-col justify-between"
        >
          <p class="text-sm leading-relaxed text-gray-800">
            Dengan nama Allah S.W.T, saya mengesahkan bahawa segala maklumat dan
            data yang diberikan di dalam Borang Permohonan dan lampiran adalah
            BENAR, TEPAT, LENGKAP dan TERKINI.
          </p>
          <div class="mt-4">
            <label class="font-medium">Saya setuju</label>
            <FormKit
