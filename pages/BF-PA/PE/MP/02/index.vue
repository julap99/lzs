          ...
          <div class="space-y-6 mt-8">
            ...
            <rs-table
              ...
              :columns="[
                ...
                { key: 'tarikhTamat', label: 'Tarikh Aktiviti' }
              ]"
              :options="{
                variant: 'default',
                hover: true,
      ...
      <template #body>
        <div class="text-center">
          ...
          <p class="text-lg mb-2">
            Adakah anda pasti untuk menghantar Kiraan Jumlah Elaun ini kepada Eksekutif JPPA?
          </p>
...
const breadcrumb = ref([
  ...
  {
    name: "Kira Jumlah Elaun Mengikut Penolong Amil",
    type: "current",
    path: "/BF-PA/PE/MP/02",
  },
]);
