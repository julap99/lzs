          ...
          <div class="flex items-start">
            ...
            <div class="flex-1">
              ...
              <div class="text-xs text-gray-600 space-y-1">
                ...
                <p><strong>Catatan:</strong> Permohonan elaun melebihi bajet telah disemak dan disokong.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex items-start justify-between p-4 bg-orange-50 rounded-lg border border-orange-200">
          <div class="flex items-start">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-orange-700 mb-2">Pengesahan elaun melebihi bajet</p>
