...
const handleBulkApproval = async () => {
  try {
    ...
    const result = await $swal.fire({
      ...
      text: `Adakah anda pasti untuk meluluskan ${selectedRows.value.length} permohonan elaun yang dipilih?`,
    ...
    if (result.isConfirmed) {
      ...
      await $swal.fire({
        icon: 'success',
        title: 'Berjaya!',
        text: `Semua permohonan elaun yang dipilih telah berjaya diluluskan`,
