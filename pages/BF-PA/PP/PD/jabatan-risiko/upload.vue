<!-- 
  ...
  ROUTE: /BF-PA/PP/PD/jabatan-risiko/upload
-->
<template>
  <div>
...
const breadcrumb = ref([
  ...
  { name: "Jabatan Risiko", type: "link", path: "/BF-PA/PP/PD/jabatan-risiko" },
  { name: "Muat Naik", type: "current", path: "/BF-PA/PP/PD/jabatan-risiko/upload" },
]);
...
const handleCancel = () => {
  navigateTo("/BF-PA/PP/PD/jabatan-risiko");
};
...
const viewUploadDetails = (uploadData) => {
  ...
  navigateTo(`/BF-PA/PP/PD/jabatan-risiko/upload-details/${uploadData.id}`);
};
</script> 
