              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                  <label class="block text-sm font-medium text-gray-700 mb-2">
                    Keputusan Sokongan <span class="text-red-500">*</span>
                  </label>
...
const breadcrumb = ref([
  ...
  },
  {
    ...
    type: "current",
    path: `/BF-PA/PP/PD/eksekutif/detail/${route.params.rujukan}`,
  },
]);
...
// Support Decision Options (No longer used - replaced with radio buttons)
