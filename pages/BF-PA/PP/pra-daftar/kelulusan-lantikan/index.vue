                    ...
                    <div>
                      ...
                      <div class="border border-gray-200 rounded-md">
                        ...
                        >
                          ...
                          <p class="text-sm">
                            Klik butang "Lihat Dokumen" untuk melihat Salinan
                            Kad Pengenalan
                          </p>
                        </div>
                    ...
                    <div>
                      ...
                      <div class="border border-gray-200 rounded-md">
                        ...
                        >
                          ...
                          <p class="text-sm">
                            Klik butang "Lihat Dokumen" untuk melihat Gambar
                            Calon
                          </p>
                        </div>
                        <div class="p-3 bg-gray-50 text-sm text-gray-500">
                  ...
                  <div class="mb-3">
                    ...
                    <p class="font-medium">
                      <span
                        class="px-2 py-1 text-sm font-medium rounded-md"
                        :class="
                          application.executiveReview.recommendation ===
                          'approve'
                            ? 'bg-green-100 text-green-800'
                            : 'bg-red-100 text-red-800'
                        "
                      ...
                      >
                        <div class="mb-6">
                          ...
                          <div class="mt-4 flex flex-col gap-2">
                            <label
                              for="finalConfirmation"
                              class="text-sm"
                            >
                              Saya mengesahkan bahawa semua maklumat dan dokumen
                              telah disemak dan keputusan saya adalah muktamad
                            </label>
...
const breadcrumb = ref([
  ...
  },
  {
    name: "Kelulusan",
    type: "link",
    path: "/BF-PA/PP/pra-daftar/sokongan-lantikan",
  },
  {
    name: "Kelulusan Lantikan",
    type: "current",
    path: "/BF-PA/PP/pra-daftar/kelulusan-lantikan",
  },
]);
...
const handleModalClose = () => {
  ...
  navigateTo("/BF-PA/PP/pra-daftar/kelulusan-lantikan-ketua-divisen");
};
