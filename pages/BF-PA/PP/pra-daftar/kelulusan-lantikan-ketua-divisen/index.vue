                      ...
                      <div class="border border-gray-200 rounded-md">
                        ...
                        >
                          <div class="flex items-center">
                            ...
                            />
                            <span>{{
                              application.documentSalinanKadPengenalan
                            }}</span>
                          </div>
                          <rs-button
                            size="sm"
                        ...
                        >
                          ...
                          <p class="text-sm">
                            Klik butang "Lihat Dokumen" untuk melihat Salinan Kad
                            Pengenalan
                          </p>
                        </div>
                        <div class="p-3 bg-gray-50 text-sm text-gray-500">
                          Dimuat naik oleh
                          {{ application.candidate.namaCalonPenolongAmil }} pada
                    ...
                    <div>
                      ...
                      <div class="border border-gray-200 rounded-md">
                        ...
                        >
                          ...
                          <p class="text-sm">
                            Klik butang "Lihat Dokumen" untuk melihat Gambar Calon
                          </p>
                        </div>
                        <div class="p-3 bg-gray-50 text-sm text-gray-500">
                          Dimuat naik oleh
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                      <p class="text-sm text-gray-500 mb-1">
                        Catatan dari Jabatan Pengurusan Risiko
                      </p>
                  ...
                  <div class="mt-6">
                    ...
                    <div class="border border-gray-200 rounded-md">
                      ...
                      >
                        ...
                        <p class="text-sm">
                          Klik butang "Lihat Dokumen" untuk melihat Surat Tapisan
                      ...
                      >
                        <div class="mb-6">
                          ...
                          <div class="mt-4 flex flex-col gap-2">
                            <label for="finalConfirmation" class="text-sm">
                              Saya mengesahkan bahawa semua maklumat dan dokumen telah disemak dan keputusan saya adalah muktamad
                            </label>
    ...
    >
      <template #body>
        <div class="text-center">
          ...
          <p class="mb-2">Permohonan lantikan Penolong Amil telah ditolak.</p>
          <p class="text-gray-600">
        ...
        <div>
          ...
          <div class="mt-4">
            <FormKit
              ...
              :placeholder="
                isRejecting
                  ? 'Masukkan sebab penolakan permohonan'
                  : 'Masukkan ulasan dan justifikasi kelulusan'
              "
              validation="required"
              :validation-messages="{
                required: isRejecting
                  ? 'Sila masukkan sebab penolakan'
                  : 'Sila masukkan ulasan',
              }"
              rows="3"
              v-model="remarks"
            />
...
const breadcrumb = ref([
  {
    name: "Penolong Amil",
    type: "link",
    path: "/BF-PA/PP/pra-daftar/tapisan-lantikan-ketua-divisen",
  },
  {
    name: "Kelulusan",
    type: "link",
    path: "/BF-PA/PP/pra-daftar/sokongan-lantikan-ketua-divisen",
  },
  {
    name: "Kelulusan Lantikan",
    type: "current",
    path: "/BF-PA/PP/pra-daftar/kelulusan-lantikan-ketua-divisen",
  },
]);
...
const goBack = () => {
  navigateTo("/BF-PA/PP/pra-daftar/kelulusan-lantikan");
};
