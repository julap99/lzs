    ...
    <rs-card class="mt-4">
      <template #header>
        <div class="flex justify-between items-center">
          <h2 class="text-xl font-semibold">Tapisan Lantikan Penolong Amil</h2>
        </div>
      </template>
                        ...
                        <div class="mb-6">
                          ...
                          <div class="mt-4 flex flex-col gap-2">
                            <label for="finalConfirmation" class="text-sm">
                              Saya mengesahkan bahawa dokumen yang dimuat naik
                              telah disahkan dan ditandatangani oleh wakil
                              institusi
                            </label>
    ...
    >
      <template #body>
        <div class="text-center">
          ...
          <p class="mb-2">
            Surat Tapisan Lantikan Penolong Amil berjaya dimuat naik dan
            dihantar.
          </p>
            ...
            <FormKit
              ...
              :placeholder="
                isRejecting
                  ...
                  : 'Masukkan catatan tambahan (jika ada)'
              "
              validation="required"
              :validation-messages="{
                required: isRejecting
                  ? 'Sila masukkan sebab penolakan'
                  : 'Sila masukkan catatan',
              }"
              rows="3"
              v-model="remarks"
            />
