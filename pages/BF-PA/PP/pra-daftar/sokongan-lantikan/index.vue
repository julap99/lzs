                        ...
                        <div class="mb-6">
                          ...
                          <div class="mt-4 flex flex-col gap-2">
                            <label for="finalConfirmation" class="text-sm">
                              Saya mengesahkan bahawa semua maklumat dan dokumen telah disemak dan keputusan saya adalah berdasarkan penilaian yang teliti dan menyokong pelantikan calon ini sebagai Penolong Amil
                            </label>
      ...
      <template #body>
        <div class="text-center">
          ...
          <p class="text-gray-600">
            Status permohonan telah dikemaskini kepada "Menunggu Kelulusan Ketua
            JPPA".
          </p>
        </div>
      </template>
            ...
            <FormKit
              ...
              :placeholder="
                isRejecting
                  ...
                  : 'Masukkan ulasan dan justifikasi sokongan'
              "
              validation="required"
              :validation-messages="{
