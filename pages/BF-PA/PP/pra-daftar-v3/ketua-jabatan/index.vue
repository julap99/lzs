...
definePageMeta({
  title: "Senarai Penolong Amil untuk Pengesahan Ketua Jabatan",
  description: "Senarai penolong amil untuk pengesahan oleh Ketua Jabatan",
});
...
// RTMF Required Table Columns for Department Head Confirmation
const columns = [
  {
    key: "no",
    label: "No",
...
const statusPendaftaranOptions = [
  ...
  { label: "Department Rejected", value: "Department Rejected" },
];
...
// RTMF Compliant Mock Data for Department Head Confirmation
const applications = ref([
  {
    ...
    tindakan: { rujukan: "PA-2024-001", statusPendaftaran: "Executive Supported" },
  },
  {
    no: 2,
    rujukan: "PA-2024-002",
  ...
  },
  {
    ...
    tindakan: { rujukan: "PA-2024-003", statusPendaftaran: "Executive Supported" },
  },
  {
    no: 4,
    rujukan: "PA-2024-004",
    ...
    statusLantikan: "Confirmed",
    tindakan: { rujukan: "PA-2024-004", statusPendaftaran: "Department Confirmed" },
  },
  {
    no: 5,
    rujukan: "PA-2024-005",
    ...
    statusPendaftaran: "Department Rejected",
    sesiPerkhidmatan: "Sesi 1",
    statusLantikan: "Rejected",
    tindakan: { rujukan: "PA-2024-005", statusPendaftaran: "Department Rejected" },
  },
]);
