...
definePageMeta({
  title: "Pengesahan Ketua Jabatan - Penolong Amil",
  description: "Senarai penolong amil untuk pengesahan ketua jabatan",
});
...
// Mock data for applications that need department head confirmation
const applications = ref([
  {
    ...
    statusPendaftaran: "MENUNGGU_PENGESAHAN_KETUA_JABATAN",
...
const statusPendaftaranOptions = ref([
  ...
  { label: "Menunggu Pengesahan Ketua Jabatan", value: "MENUNGGU_PENGESAHAN_KETUA_JABATAN" },
  { label: "Pengesahan Diberikan", value: "PENGESAHAN_DIBERIKAN" },
  { label: "Pengesahan Ditolak", value: "PENGESAHAN_DITOLAK" },
]);
...
const getStatusPendaftaranVariant = (status) => {
  const variants = {
    "MENUNGGU_PENGESAHAN_KETUA_JABATAN": "warning",
    "PENGESAHAN_DIBERIKAN": "success",
    "PENGESAHAN_DITOLAK": "danger",
  };
...
const handleView = (application) => {
  navigateTo(`/BF-PA/PP/pra-daftar-v3/ketua-jabatan/detail/${application.rujukan}`);
};

const handleConfirm = (application) => {
  // Update status to show department head confirmation given
  application.statusPendaftaran = "PENGESAHAN_DIBERIKAN";
  alert(`Pengesahan ketua jabatan telah diberikan untuk ${application.namaCalon}`);
};
</script> 