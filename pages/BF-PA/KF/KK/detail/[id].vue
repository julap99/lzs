              ...
              <div class="flex items-start">
                ...
                <div class="flex-1">
                  ...
                  <div class="text-xs text-gray-600 space-y-1">
                    ...
                    <p><strong>Catatan:</strong> Sokongan diberikan untuk perubahan kategori penolong amil</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="flex items-start">
                ...
                <div class="flex-1">
                  ...
                  <div class="text-xs text-gray-600 space-y-1">
                    ...
                    <p><strong>Catatan:</strong> Perubahan kategori disahkan dan layak untuk kelulusan ketua divisyen</p>
                  </div>
                </div>
              </div>
            </div>
