  ...
  <div>
    ...
    <rs-card class="p-6">
      ...
      <div v-if="currentStep === 1" class="space-y-6">
        ...
        >
          ...
          <FormKit
            type="text"
            name="organizationName"
            label="No Passport / Foreign ID (Jika bukan warganegara)"
            placeholder="Masukkan no passport / foreign ID"
          />
      ...
      <div v-if="currentStep === 4" class="space-y-6">
        <h2 class="text-xl font-semibold border-b pb-2">D) Maklumat Bank</h2>
      ...
      <div v-if="currentStep === 6" class="text-center py-8">
        ...
        <div>
          ...
          <div class="flex justify-center">
            <rs-button
              @click="navigateTo('/BF-PRF/TP/PP/03')"
              variant="primary-outline"
