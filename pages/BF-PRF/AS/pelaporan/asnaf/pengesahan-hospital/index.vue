<template>
  <div>
    ...
    <!-- Kepala Surat (rujukan + tarikh + alamat LZS) -->
    <rs-card class="mb-6">
      <template #body>
        <!-- Rujukan & Tarikh -->
    ...
    <rs-card class="mb-6">
      <template #body>
        <div class="space-y-4 text-sm text-[rgb(var(--text-color))]">
          ...
          <!-- 1 -->
          <p>
            1. Semoga surat ini menemui tuan/puan di dalam kemanisan iman serta memperoleh rahmat daripada Allah s.w.t. Amin.
          </p>
            ...
            <tbody>
              ...
              <tr>
                <td class="p-2 border-t border-r border-gray-800 font-medium align-top">
                  Nama Pesakit @ Tanggungan / Kad Pengenalan
                </td>
          ...
          <!-- 3 -->
          <p>
            3. Dengan ini segala hormatnya kami merujuk kepada <span class="font-semibold">Surat Pekeliling Bahagian
            Kewangan (Unit Pengurusan Hasil) Bilangan 14 Tahun 2004</span> yang menyatakan bahawa golongan fakir dan
            miskin yang menerima bantuan bulanan di bawah peruntukan zakat dari Majlis Agama Islam Negeri merupakan
            golongan yang sama tarafnya dengan golongan yang mendapat bantuan Jabatan Kebajikan Masyarakat.
          </p>

          <!-- 4 -->
          <p>
            4. Oleh yang demikian, golongan fakir dan miskin yang menerima bantuan bulanan dari Majlis Agama Islam Negeri
            adalah <span class="font-semibold">dikecualikan</span> daripada bayaran caj rawatan hospital dan kemudahan
            perubatan pesakit luar dan wad Kelas 3 di mana-mana Hospital/Klinik Kesihatan seperti yang dinyatakan dalam
            surat Kementerian Kewangan <span class="font-semibold">Bil. KPK(PS) 096/28/2793 Jld.3 Sk. 6/2004(3)</span>
            bertarikh 5 Mei 2004.
          </p>

          <!-- 5 -->
          <p>
            5. Sehubungan itu, adalah dihargai agar pihak tuan/puan dapat <span class="font-semibold">mengecualikan</span>
            bayaran caj rawatan hospital dan kemudahan rawatan perubatan pesakit luar dan wad Kelas 3 kepada penerima
            bantuan zakat yang dinyatakan di atas. Sebarang pertanyaan berkaitan perkara di atas, sila hubungi
            Talian Zakat Selangor 1-300-88-4343.
          </p>

          <!-- 6 -->
          <div>
            6. Sekian, <span class="text-xl text-gray-700">وَالسَّلَامُ عَلَيْكُمْ وَرَحْمَةُ ٱللَّهِ وَبَرَكَاتُهُ</span>
          </div>
        ...
        <div class="space-y-4 mt-6">
          ...
          <div class="text-sm">Ketua Operasi Agihan Daerah {{ surat.daerah }}</div>
        </div>
      </template>
    </rs-card>

    <!-- Modal -->
    <rs-modal v-model="showSurat" title="Surat Pengesahan Asnaf – Hospital">
      <template #footer>
...
const surat = ref({
  ...
  tanggungan: [
    { nama: 'MUHAMMAD SHAARNAS ANAQI BIN MUHAMMAD NASMI', ic: '211107101507' },
  ],
  alamat: [
    'NO. 21,',
    'JALAN ARQWAN 4B',
...
const downloadSuratHospital = () => {
  alert('Muat turun Surat Pengesahan Asnaf – Hospital...')
