          ...
          <FormKit type="form" :actions="false" @submit="handleSubmit">
            ...
            <div v-if="currentStep === 1">
              ...
              <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <template
                    v-if="
                      formData.personalInfo.citizenship === 'lain-lain' &&
                      formData.personalInfo.idType === 'foreign-id'
                    "
                  >
                    <FormKit
                      type="date"
              ...
              <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div
                    v-if="formData.personalInfo.adakah_muallaf === 'Y'"
                    class="md:col-span-2"
                  >
                    <FormKit
                      type="file"
              ...
              <div
                v-if="formData.personalInfo.maritalStatus === 'berkahwin'"
                class="md:col-span-2"
              >
                <div class="flex justify-between items-center mb-3">
                  <h4 class="text-md font-medium">
                    Maklumat Pasangan/Ahli Keluarga
                  </h4>
                  <rs-button
                    type="button"
                    variant="primary-outline"
              ...
              >
                <div
                  v-for="(spouse, index) in formData.personalInfo.spouses"
                  :key="index"
              ...
              <div
                v-if="formData.personalInfo.paymentMethod === 'tiada'"
                class="md:col-span-2"
              >
                <FormKit
                  type="checkbox"
            ...
            <div v-if="currentStep === 3">
              ...
              <div class="mb-6">
                ...
                <div
                  v-if="formData.verification.hubunganKakitanganLZS === 'Ya'"
                ...
                <div class="flex flex-col gap-2 mt-6">
                  <label class="font-medium"
                    >Adakah PAK membantu semasa pengisian borang permohonan
                    ini?</label
                  >
                  <FormKit
                    type="radio"
                ...
                <div
                  v-if="formData.verification.pakAssistance === 'Ya'"
                  class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4"
                >
                  <FormKit
                    type="select"
                ...
                <div class="flex flex-col gap-2 mt-6">
                  <label class="font-medium"
                    >Hubungan kekeluargaan dengan PAK?</label
                  >
                  <FormKit
                    type="radio"
                    name="hubungan_pak"
                ...
                <div
                  v-if="formData.verification.hubunganPAK === 'Ya'"
                  class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4"
                >
                  <FormKit
                    type="select"
                  ...
                  <div class="flex items-start gap-3">
                    ...
                    <div class="text-sm text-gray-700">
                      <p class="text-sm leading-relaxed text-gray-800">
                        ...
                        maklumat dan data yang diberikan di dalam Borang
                        Permohonan Agihan dan lampiran adalah BENAR, TEPAT,
                        LENGKAP dan TERKINI. Saya dengan ini bersetuju memberi
                        persetujuan secara nyata (explicit consent) kepada Zakat
                        Selangor untuk mengumpul, memproses, menggunakan data
                        peribadi saya dan tanggungan saya (jika ada) bagi tujuan
                        pentadbiran, kajian, dakwah, promosi dan
                        aktiviti-aktiviti lain berkaitan fungsi Zakat Selangor
                        seperti yang dinyatakan di dalam Notis Privasi Zakat
                        Selangor di https://www.zakatselangor.com.my.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div v-if="currentStep === 4">
              <h3 class="text-lg font-semibold mb-4">
                4. Maklumat Pengesah Bermastautin
              </h3>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormKit
                  ...
                  :value="
                    getPakOfficerLabel(formData.verification.selectedPakOfficer)
                  "
                  disabled
                />
...
const citizenshipOptions = computed(() => {
  if (formData.value.personalInfo.idValue === "ic") {
    ...
    return [{ label: "Malaysia", value: "malaysia" }];
...
const selectedBankSwiftCode = computed(() => {
  const selectedBank = bankOptions.find(
    (bank) => bank.value === formData.value.personalInfo.bankName
  );
...
const getSpousePlaceholder = (index) => {
  ...
  return (
    placeholders[formData.value.personalInfo.spouses[index]?.spouseIdType] || ""
  );
};
  ...
  (newVal) => {
    ...
    if (count > 0) {
      ...
      formData.value.personalInfo.wives =
        formData.value.personalInfo.wives.slice(0, count);
    } else {
      formData.value.personalInfo.wives = [];
    }
  }
...
watch(
  ...
  (newVal) => {
    if (newVal) {
      ...
      formData.value.personalInfo.swiftCode = selectedBank
...
watch(
  () => formData.value.addressInfo.residenceYears,
  (newVal) => {
...
watch(
  () => formData.value.verification.selectedKariah,
  (newVal) => {
...
watch(
  () => formData.value.verification.selectedKariahPAK,
  (newVal) => {
...
watch(
  () => formData.value.verification.selectedKariahAssistance,
  (newVal) => {
...
watch(
  () => formData.value.personalInfo.idValue,
  (newVal) => {
...
const goBack = () => {
  // For all steps, go back to previous step
...
const handleSaveStep1 = async () => {
  try {
    ...
    console.log("Langkah 1 (Peribadi) disimpan:", step1Data);
...
const handleSaveStep2 = async () => {
  try {
    ...
    // Here you would typically send this data to your backend
    console.log("Langkah 2 (Alamat) disimpan:", step2Data);
...
const handleSaveStep3 = async () => {
  try {
    ...
    const step3Data = {
      verification: {
        hubunganKakitanganLZS:
          formData.value.verification.hubunganKakitanganLZS,
    ...
    // Here you would typically send this data to your backend
    console.log("Langkah 3 (Pengesahan) disimpan:", step3Data);
...
const handleSaveStep4 = async () => {
  try {
    ...
    const step4Data = {
      verification: {
        ...
        tarikhPengesahanPermastautin:
          formData.value.verification.tarikhPengesahanPermastautin,
        dokumenPengesahanPermastautin:
    ...
    // Here you would typically send this data to your backend
    console.log("Langkah 4 (Bermastautin) disimpan:", step4Data);
...
const handleSaveStep5 = async () => {
  try {
    ...
    // Here you would typically send this data to your backend
    console.log("Langkah 5 (Pegawai Pendaftar) disimpan:", step5Data);
