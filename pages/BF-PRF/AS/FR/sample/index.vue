...
const tarikhMasukIslam = ref('2020-06-15');
const tarikhMasukIslamTanggungan = ref('2020-06-15');
...
const formData = ref({
  ...
  nama_selepas_islam: 'Ahmad bin Abdullah',
  tarikh_masuk_islam: '2020-06-15',
  tarikh_masuk_kfam: '2020-07-01',
  status_perkahwinan: 'Berkahwin',

  // Bank Information
  nama_bank: 'maybank',
  no_akaun_bank: '1234567890',
  nama_pemegang_akaun: 'Ahmad bin Abdullah',
  swift_code: 'MBBEMYKL',
  ...
  addressInfo: {
    ...
    tapak_rumah: 'Rumah Teres',
    jenis_rumah: 'Rumah Teres',
    binaan_rumah: 'Simen',
  ...
  bayaran_bulanan: '500',
  jumlah_perbelanjaan: '25000',
  tahun_mula_pinjaman: '2022',
  tahun_akhir_pinjaman: '2027',
  ...
  ulasan_pengesahan: 'Pemohon telah bermastautin di Selangor selama 5 tahun dan layak untuk bantuan.',
  surat_pengesahan_bermastautin: {
  ...
  tarikh_proses: new Date().toISOString().split('T')[0],

  // Section J - Penilaian Awal
  komitmen_tinggi: 'Y',
  keperluan_mendesak: ['perubatan', 'tunggakanUtiliti'],
  lain_keperluan: 'Keperluan untuk pembedahan jantung',
  dokumen_sokongan: [
    {
  ...
  hubungan_pemohon: 'Pasangan',
  nama_tanggungan: 'Siti binti Mohamed',
  jenis_id_tanggungan: 'Kad Pengenalan',
  no_pengenalan_tanggungan: '901231025679',
  jantina_tanggungan: 'Perempuan',
  tarikh_lahir_tanggungan: '1992-05-15',
  tempat_lahir_tanggungan: 'Kuala Lumpur',
  bangsa_tanggungan: 'Melayu',
  status_perkahwinan_tanggungan: 'Berkahwin',
  tarikh_masuk_islam_tanggungan: '2020-06-15',
  tarikh_masuk_kfam_tanggungan: '2020-07-01',
  warganegara_tanggungan: 'Warganegara',
  tempoh_menetap_selangor: '5',
  no_telefon_tanggungan: '0123456790',

  // Maklumat Perbankan Tanggungan
  nama_bank_tanggungan: 'maybank',
  swift_code_tanggungan: 'MBBEMYKL',
  no_akaun_bank_tanggungan: '1234567891',
  nama_pemegang_akaun_tanggungan: 'Siti binti Mohamed',
  ...
  alamat_sekolah: 'Jalan Pendidikan, Shah Alam',
  daerah_sekolah: 'shah-alam',
  negeri_sekolah: 'Selangor',
  poskod_sekolah: '40000',
  nama_sekolah_agama: 'Sekolah Agama Menengah',
  alamat_sekolah_agama: 'Jalan Agama, Shah Alam',
  daerah_sekolah_agama: 'shah-alam',
  ...
  kemahiran_tanggungan: 'Memasak',

  // Pekerjaan Tanggungan
  pekerjaan_status: 'Bekerja',
  sektor_pekerjaan: 'Perkhidmatan',
  nama_majikan: 'Restoran Seri Melayu',
  no_tel_majikan: '03-12345678',
  alamat_majikan: 'Jalan Restoran, Shah Alam',
  bandar_majikan: 'Shah Alam',
  poskod_majikan: '40000',
  daerah_majikan: 'shah-alam',
...
const uploadedDocuments = computed(() => {
  ...
  if (formData.value.dokumen_sokongan && formData.value.dokumen_sokongan.length > 0) {
    formData.value.dokumen_sokongan.forEach(doc => {
      documents.push({
  ...
  // Add surat pengesahan bermastautin
  if (formData.value.surat_pengesahan_bermastautin) {
    const doc = formData.value.surat_pengesahan_bermastautin;
    documents.push({
      name: getDocumentName(doc),
      type: getDocumentType(doc),
      size: getDocumentSize(doc),
