        ...
        <div class="space-y-4">
          <div class="bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <p class="text-sm text-red-700 mt-2">
              Anda akan memadam maklumat cawangan berikut:
            </p>
            <div class="mt-2 p-2 bg-white border rounded text-sm">
              <strong>{{ itemToDelete?.noRujukan }}</strong> - {{ itemToDelete?.namaCawangan }}
            </div>
          </div>
...
const cawanganList = ref([
  {
    ...
    tindakan: { id: 'CB-240501', status: 'Menunggu Pengesahan' },
  },
  {
    noRujukan: 'CB-240502',
    ...
    status: 'Diluluskan',
    tindakan: { id: 'CB-240502', status: 'Diluluskan' },
  },
  {
    noRujukan: 'CB-240503',
    ...
    status: 'Ditolak',
    tindakan: { id: 'CB-240503', status: 'Ditolak' },
  },
  {
    noRujukan: 'CB-240504',
    ...
    status: 'Menunggu Pengesahan',
    tindakan: { id: 'CB-240504', status: 'Menunggu Pengesahan' },
  },
]);
...
// CRUD Operations
const viewItem = (id) => navigateTo(`/BF-PRF/OR/PB/view/${id}`);
const editItem = (id) => navigateTo(`/BF-PRF/OR/PB/kemaskini/${id}`);
...
const confirmDeleteAction = () => {
  ...
  const index = cawanganList.value.findIndex(
    item => item.noRujukan === itemToDelete.value.noRujukan
  );
  
  if (index !== -1) {
    cawanganList.value.splice(index, 1);
...
const viewCawangan = (id) => viewItem(id);
</script> 