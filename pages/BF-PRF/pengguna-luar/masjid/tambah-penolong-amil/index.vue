      ...
      <template #header>
        <div class="flex justify-between items-center">
          <h2 class="text-xl font-semibold">
            Borang Pendaftaran Calon Penolong Amil - Masjid
          </h2>
        </div>
      </template>
          ...
          >
            ...
            <div class="mb-8 p-6 border border-gray-200 rounded-lg">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Kategori Penolong Amil (Multi-Select for Masjid) -->
                <div class="md:col-span-2">
                  <label class="block text-sm font-medium text-gray-700 mb-2">
                    Kategori Penolong Amil * (Masjid: PAF, PAK, PAP sahaja)
                  </label>
                  ...
                  <p class="mt-1 text-xs text-gray-500">
                    Masjid boleh memilih PAF, PAK, PAP sahaja
                  </p>
...
definePageMeta({
  title: "Tambah Penolong Amil - Masjid",
  description: "Borang pendaftaran calon penolong amil untuk masjid",
});
...
// Kategori Penolong Amil Options (Masjid: PAF, PAK, PAP only)
const kategoriPenolongAmilOptions = ref([
  ...
  { label: "PAK+ (Penolong Amil Komuniti)", value: "PAK+", disabled: true },
]);
