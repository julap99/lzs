        ...
        >
          <div>
            <h1 class="text-2xl font-bold text-gray-900">
              Semakan Laporan Gambar
            </h1>
            <p class="mt-1 text-sm text-gray-600">
              Semak gambar lokasi dan dokumentasi siasatan lapangan
            </p>
          </div>
          <rs-button
...
const breadcrumb = ref([
  ...
  },
  {
    name: "Laporan Gambar",
    type: "current",
    path: `/BF-BTN/tugasan/bantuan/sokongan/${route.params.id}/laporan-gambar`,
  },
]);
