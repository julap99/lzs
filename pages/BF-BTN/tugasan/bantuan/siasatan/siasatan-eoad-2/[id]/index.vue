                ...
                <div class="space-y-8">
                  ...
                  <div>
                    <rs-collapse>
                      ...
                      <!-- Syor -->
                      <rs-collapse-item type="card" title="Syor">
                        <div class="p-4 space-y-4">
                          ...
                          >
                            ...
                            <template v-slot:terimaCadangan="{ value }">
                              <FormKit type="checkbox" v-model="value.terimaCadangan" outer-class="mb-0" />
                            </template>
                          </rs-table>
                      ...
                      <!-- Perubahan Bantuan -->
                      <rs-collapse-item type="card" title="Perubahan Bantuan">
