...
const viewBQ = (bq) => {
  ...
  router.push(
    `/BF-BTN/tugasan/bantuan/kelulusan/${route.params.id}/draf-bq?view=true`
  );
};
...
const viewLaporanGambar = () => {
  router.push(
    `/BF-BTN/tugasan/bantuan/kelulusan/${route.params.id}/laporan-gambar?view=true`
  );
};
...
const viewArahanKerja = () => {
  router.push(
    `/BF-BTN/tugasan/bantuan/kelulusan/${route.params.id}/arahan-kerja`
  );
};

const urusPemantauan = () => {
  router.push(
    `/BF-BTN/tugasan/bantuan/kelulusan/${route.params.id}/pemantauan`
  );
};
