        ...
        >
          <div>
            <h1 class="text-2xl font-bold text-gray-900">
              Kelulusan Laporan Gambar
            </h1>
            <p class="mt-1 text-sm text-gray-600">
              Semak gambar lokasi dan dokumentasi siasatan lapangan untuk
              kelulusan
            </p>
          </div>
          <rs-button
      ...
      <div class="space-y-6">
            ...
            <div class="space-y-6">
              ...
              <div v-if="uploadQueue.length > 0" class="space-y-3">
                <h3 class="text-sm font-medium text-gray-900">
                  Senarai Fail untuk Dimuat Naik:
                </h3>
                <div class="space-y-2">
                  <div
        ...
        <rs-card class="shadow-sm border-0 bg-white">
          ...
          <template #body>
            ...
            <div v-else class="text-center py-8 text-gray-500">
              ...
              />
              <p>
                Tiada gambar dimuat naik. Sila muat naik gambar menggunakan
                bahagian di atas.
              </p>
            </div>
          </template>
        ...
        <rs-card class="p-4">
          <div class="flex flex-col sm:flex-row gap-3 justify-end">
            <rs-button variant="primary" @click="handleBack">
              Kembali
            </rs-button>

            <rs-button variant="primary" @click="handleSaveAndReturn">
              Simpan & Kembali
            </rs-button>
          </div>
        </rs-card>
      ...
      <template #body>
        <div v-if="previewingImage" class="space-y-4">
          ...
          <div class="text-sm text-gray-600">
            ...
            {{ previewingImage.catatan || "Tiada catatan" }}
          </div>
          <div class="text-xs text-gray-500">
            <strong>Masa Upload:</strong>
            {{ formatDateTime(previewingImage.masaUpload) }}
          </div>
        </div>
      </template>
      <template #footer>
...
definePageMeta({
  title: "Kelulusan - Laporan Gambar",
});
...
const breadcrumb = ref([
  ...
  },
  {
    name: "Laporan Gambar",
    type: "current",
    path: `/BF-BTN/tugasan/bantuan/kelulusan/${route.params.id}/laporan-gambar`,
  },
]);
