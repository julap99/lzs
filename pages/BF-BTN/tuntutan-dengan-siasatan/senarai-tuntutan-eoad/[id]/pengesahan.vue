...
const detailsById: Record<string, TuntutanDetail> = {
  'TUN-2024-001': {
    ...
    tuntutan: { noInvois: 'INV-2024-001', noInvoisPelanggan: 'CUST-INV-7788', tajuk: 'Pembekalan Karpet', tahun: '2024', catatan: '—', penerimaBayaran: 'Syarikat ABC Sdn Bhd', mop: 'EFT', namaPenerima: 'SYARIKAT ABC SDN BHD', bank: 'Maybank', noAkaun: '5123 4567 8910', tarikhJangkaan: '2025-08-15', tarikhCipta: new Date().toISOString(), amaunRm: 5000 },
  ...
  'TUN-2024-002': {
    ...
    tuntutan: { noInvois: 'INV-2024-002', noInvoisPelanggan: 'CUST-INV-8899', tajuk: 'Pembekalan Kipas Industri', tahun: '2024', catatan: 'Termasuk pemasangan.', penerimaBayaran: 'Syarikat Angin Sejuk Sdn Bhd', mop: 'EFT', namaPenerima: 'SYKT ANGIN SEJUK SDN BHD', bank: 'CIMB', noAkaun: '8600 2233 4455', tarikhJangkaan: '2025-09-20', tarikhCipta: new Date(Date.now() - 86400000).toISOString(), amaunRm: 8000 },
  ...
  'TUN-2024-004': {
    ...
    tuntutan: { noInvois: 'INV-2024-004', noInvoisPelanggan: 'CUST-INV-5566', tajuk: 'Pembekalan Sistem PA', tahun: '2024', catatan: 'Ujian bunyi selesai.', penerimaBayaran: 'Audio Harmoni Sdn Bhd', mop: 'EFT', namaPenerima: 'AUDIO HARMONI SDN BHD', bank: 'Bank Islam', noAkaun: '1200 5566 7788', tarikhJangkaan: '2025-06-30', tarikhCipta: new Date(Date.now() - 259200000).toISOString(), amaunRm: 3500 },
  ...
  'TUN-2024-005': {
    ...
    tuntutan: { noInvois: 'INV-2024-005', noInvoisPelanggan: 'CUST-INV-6677', tajuk: 'Pembekalan Katil Asrama', tahun: '2024', catatan: '—', penerimaBayaran: 'Asrama Warna Sdn Bhd', mop: 'EFT', namaPenerima: 'ASRAMA WARNA SDN BHD', bank: 'Public Bank', noAkaun: '3333 7777 9999', tarikhJangkaan: '2025-10-05', tarikhCipta: new Date(Date.now() - 345600000).toISOString(), amaunRm: 15000 },
