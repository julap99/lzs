...
const detailsById: Record<string, TuntutanDetail> = {
  'TUN-2024-001': {
    ...
    tuntutan: { noInvois: 'INV-2024-001', noInvoisPelanggan: 'CUST-INV-7788', tajuk: 'Pembekalan Karpet', tahun: '2024', catatan: '—', penerimaBayaran: 'Syarikat ABC Sdn Bhd', mop: 'EFT', namaPenerima: 'SYARIKAT ABC SDN BHD', bank: 'Maybank', noAkaun: '5123 4567 8910', tarikhJangkaan: '2025-08-15', tarikhCipta: new Date().toISOString(), amaunRm: 5000, amaunGL: 6000, bakiAmaun: 1000 },
