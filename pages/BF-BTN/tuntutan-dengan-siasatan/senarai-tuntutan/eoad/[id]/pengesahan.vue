        ...
        <template #body>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <rs-badge :variant="getStatusVariant(pemohon.statusHousehold)">{{ pemohon.statusHousehold || '-' }}</rs-badge>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Status Individu</label>
              <rs-badge :variant="getStatusVariant(pemohon.statusIndividu)">{{ pemohon.statusIndividu || '-' }}</rs-badge>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Status Multidimensi</label>
              <rs-badge :variant="getStatusVariant(pemohon.statusMultidimensi)">{{ pemohon.statusMultidimensi || '-' }}</rs-badge>
            </div>
          </div>
        </template>
      </rs-card>
...
const detailsById: Record<string, TuntutanDetail> = {
  'TUN-2024-001': {
    ...
    pemohon: {
      nama: 'Masjid Al-Fatonah',
      noId: 'VND-9988',
      noTelefon: '012-3456789',
      kategoriAsnaf: 'Fi Sabilillah',
      emel: 'info@masjidfatonah.my',
  statusHousehold: 'Non-Fakir Miskin',
  ...
  'TUN-2024-003': {
    ...
    pemohon: {
      nama: 'PUSAT HEMODIALISIS PERMATA SDN. BHD.',
      noId: 'VND-2211',
      noTelefon: '03-7777 2211',
      kategoriAsnaf: 'Miskin',
      emel: 'info@hemodialisispermata.com',
  statusHousehold: 'Miskin',
  statusIndividu: 'Tidak Produktif',
  statusMultidimensi: 'Produktif Tegar',
    },
  ...
  'TUN-2024-004': {
    ...
    pemohon: {
      ...
      kategoriAsnaf: 'Fi Sabilillah',
      emel: 'admin@suraukampungbaru.my',
  statusHousehold: 'Produktif',
  statusIndividu: 'Produktif Sementara',
  statusMultidimensi: 'Produktif',
    },
  ...
  'TUN-2024-005': {
    ...
    pemohon: {
      ...
      kategoriAsnaf: 'Fi Sabilillah',
      emel: 'info@tahfizquran.my',
  statusHousehold: 'Produktif',
  statusIndividu: 'Produktif',
  statusMultidimensi: 'Produktif',
    },
...
// Helpers for rs-badge variant for status fields
// Unified badge variant logic (as in mohon-tuntutan/asnaf/[id]/index.vue)
