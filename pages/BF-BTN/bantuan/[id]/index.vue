...
// B011 specific distribution items
const b011DistributionItems = [
  {
    diNo: 'DI-2025-123456',
    entitlementProduct: '(HQ) DERMASISWA IPT DALAM NEGARA (FAKIR) - IPTA/IPTS',
    penerima: 'Asnaf',
...
// B011 specific process flow with 2025 dates
const b011ProcessFlow = [
  {
    status: 'Permohonan',
    namaPegawai: 'Siti binti Ali',
    tarikhMasa: '2025-01-01 09:00:00',
  ...
  },
  {
    ...
    namaPegawai: 'Mohd bin Ibrahim',
    tarikhMasa: '2025-01-04 16:45:00',
    catatan: 'Permohonan diluluskan untuk bantuan'
  }
]
