  ...
  <div>
    ...
    <div class="print-only mb-6">
      <div class="flex justify-between items-center">
        <h1 class="text-xl font-bold text-gray-900">Surat Kelulusan Bantuan</h1>
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-600 mt-1">
            Surat kelulusan bantuan untuk {{ applicantInfo.namaPenuh }}
          </p>
        </div>
        <div class="flex gap-2">
          <rs-button variant="primary" @click="handlePrint">
    ...
    <div class="letter-container bg-white p-8 shadow-lg">
      ...
      <div class="letter-intro mb-8">
        ...
        <div class="mb-4">
          <h3 class="text-lg font-bold text-gray-900 mb-2">
            MAKLUM BALAS PERMOHONAN BANTUAN ZAKAT DI LEMBAGA ZAKAT SELANGOR
            (MAIS)
          </h3>
        </div>
        ...
        <div class="mb-6 text-justify">
          <p class="text-gray-900 leading-relaxed">
            Semoga surat ini menemui tuan / puan di dalam kemanisan iman serta
            memperoleh keberkatan dan kerahmatan daripada Allah S.W.T., In Shaa
            Allah.
          </p>
        </div>
        ...
        <div class="mb-6 text-justify">
          <p class="text-gray-900 leading-relaxed">
            Sukacita dimaklumkan bahawa Lembaga Zakat Selangor (MAIS) telah
            <strong>MELULUSKAN</strong> permohonan bantuan zakat seperti
            berikut.
          </p>
        </div>
      </div>
      ...
      <div class="letter-table mb-8">
        <table class="w-full border-collapse border border-gray-300">
          <thead>
            <tr class="bg-gray-50">
              <th
                class="border border-gray-300 px-4 py-3 text-left font-semibold text-gray-900 w-16"
              >
                No
              </th>
              <th
                class="border border-gray-300 px-4 py-3 text-left font-semibold text-gray-900 w-48"
              >
                Perkara
              </th>
              <th
          ...
          <tbody>
            <tr>
              <td
                class="border border-gray-300 px-4 py-3 text-center font-medium"
              >
                1
              </td>
            ...
            <tr>
              <td
                class="border border-gray-300 px-4 py-3 text-center font-medium"
              >
                {{ aidInfo.namaVendor ? "7" : "6" }}
              </td>
              <td class="border border-gray-300 px-4 py-3 font-medium">
                Jumlah Bantuan Keseluruhan
              </td>
              <td class="border border-gray-300 px-4 py-3 font-semibold">
                RM {{ aidInfo.jumlahBantuanKeseluruhan }}
              </td>
            </tr>
            <tr>
              <td
            ...
            <tr>
              <td
                class="border border-gray-300 px-4 py-3 text-center font-medium"
              >
                {{ aidInfo.namaVendor ? "9" : "8" }}
              </td>
              <td class="border border-gray-300 px-4 py-3 font-medium">
                Kaedah Penyaluran Bantuan
              </td>
              <td class="border border-gray-300 px-4 py-3">
                {{ aidInfo.kaedahPenyaluran }}
              </td>
            </tr>
            <tr v-if="aidInfo.melibatkanTuntutan">
              <td
                class="border border-gray-300 px-4 py-3 text-center font-medium"
              >
                {{ aidInfo.namaVendor ? "10" : "9" }}
              </td>
              <td class="border border-gray-300 px-4 py-3 font-medium">
                Dokumen-dokumen Tuntutan Pembayaran
              </td>
              <td class="border border-gray-300 px-4 py-3">
                <p class="mb-2">(Sila lampirkan sewaktu tuntutan)</p>
                <ul class="list-disc list-inside space-y-1">
                  <li v-for="doc in aidInfo.dokumenTuntutan" :key="doc">
                    {{ doc }}
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td class="border border-gray-300 px-4 py-3">
                <ul class="list-disc list-inside space-y-1">
                  <li v-for="info in aidInfo.maklumatPenting" :key="info">
                    {{ info }}
                  </li>
                </ul>
              </td>
      ...
      <div class="letter-footer mt-12">
        <div class="text-right">
          <p class="text-gray-900 mb-4">Sekian, terima kasih.</p>
          <div class="mt-8">
            <p class="text-gray-900 font-semibold">Yang benar,</p>
            <div class="mt-8">
              ...
              <p class="text-gray-900">Lembaga Zakat Selangor (MAIS)</p>
            </div>
          </div>
        </div>
      </div>
...
const profileInfo = ref({
  alamatPejabat:
    "Tingkat 1, Wisma MAIS, No. 1, Jalan SS 6/2, 47301 Petaling Jaya, Selangor",
