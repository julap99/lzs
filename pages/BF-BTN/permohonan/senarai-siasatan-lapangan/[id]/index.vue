            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                <div class="flex-shrink-0">
                  ...
                  >
                    <Icon name="ph:file-text" class="w-6 h-6 text-purple-600" />
                  </div>
                </div>
                <div>
                  <h2 class="text-lg font-semibold text-gray-900">Draf BQ</h2>
                  <p class="text-sm text-gray-500">
                    Bill of Quantity untuk kerja-kerja cadangan
                  </p>
                </div>
              </div>
              <rs-button variant="primary" @click="openBQForm">
              ...
              <div class="space-y-1">
                ...
                <div class="mt-1 p-3 bg-gray-50 rounded-lg border">
                  <span class="text-sm font-medium text-gray-900">
                    RM {{ laporanTeknikal.nilaiKerja?.toLocaleString() || "0" }}
                  </span>
                </div>
              </div>
            </div>
