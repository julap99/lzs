...
const handleRework = () => {
  // Validate that required fields are filled for rework
  if (!formData.value.statusPermohonanBaru) {
    // Form validation will handle this
    return;
  }

  // Save data and insert audit trail
  console.log("Processing Rework:", formData.value);

  // Update status to 'Rework Required'
  formData.value.statusPermohonanBaru = "Rework Required";

  // Trigger workflow to ETD (BF-NAS-BTN-PB-MB-BDST-09)
  // This would typically be an API call to trigger the workflow

  // Set action type for modal display
  actionType.value = "rework";

  // Show success modal
  showSuccessModal.value = true;
};

const handleSahkanSokongan = () => {
  ...
  // Save data and insert audit trail
  console.log("Processing Sahkan Sokongan:", formData.value);

  // Update status and trigger next stage to Peringkat Kelulusan
  formData.value.statusPermohonanBaru = "Sokongan Disahkan";

  // Trigger next stage workflow
  // This would typically be an API call to move to next approval stage

  // Set action type for modal display
  actionType.value = "sahkan";
...
const getModalTitle = () => {
  switch (actionType.value) {
    case "rework":
      return "Rework Diperlukan";
    case "sahkan":
      return "Sokongan Disahkan";
    default:
...
const getModalMessage = () => {
  switch (actionType.value) {
    case "rework":
      return "Permohonan telah dihantar kembali kepada ETD untuk tindakan rework.";
    case "sahkan":
      return "Permohonan telah disahkan dan akan diteruskan ke Peringkat Kelulusan.";
    default:
