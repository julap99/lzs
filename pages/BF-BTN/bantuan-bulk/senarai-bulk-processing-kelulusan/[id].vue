      ...
      <rs-card>
        <template #header>
          <div class="flex items-center space-x-3">
            <div class="flex-shrink-0">
              <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center">
                <Icon name="material-symbols:checklist" class="w-6 h-6 text-gray-600" />
              </div>
            </div>
            <div>
              <h2 class="text-xl font-semibold text-gray-900">Maklumat Kelulusan</h2>
              <p class="text-sm text-gray-500">Maklumat kelulusan dan penolakan</p>
            </div>
          </div>
        </template>
        <template #body>
...
const breadcrumb = ref([
  ...
  {
    name: `Lihat Bulk Processing Kelulusan ${id}`,
    type: 'current',
    path: `/BF-BTN/bantuan-bulk/senarai-bulk-processing-kelulusan/${id}`,
  },
])
...
const editBantuan = () => {
  navigateTo(`/BF-BTN/bantuan-bulk/senarai-bulk-processing-kelulusan/${id}/edit`);
};
