      ...
      <template #header>
        <div class="flex justify-between items-center">
          <h2 class="text-xl font-semibold">
            Senarai Permohonan - Untuk Sahkan Lawatan
          </h2>
        </div>
      </template>
          ...
          <template v-slot:tindakan="{ text }">
            <div class="flex justify-center items-center gap-2">
              <rs-button
                ...
                @click="handleSahkanLawatan(text)"
              >
...
// Options for filters
const statusOptions = [{ label: "Syor Bantuan Dikemukakan", value: "syor_bantuan_dikemukakan" }];

// State
const searchQuery = ref("");
const filters = ref({
  status: "syor_bantuan_dikemukakan", // Default to "Syor Bantuan Dikemukakan"
});
...
// Methods
const handleSahkanLawatan = (noRujukan) => {
  navigateTo(`/BF-BTN/PB/senarai-sahkan-lawatan/${noRujukan}/sahkan`);
};
