  ...
  <div class="">
    ...
    <div class="mb-6">
      <h1 class="text-2xl font-semibold text-gray-900">
        Senarai Pemohon Bantuan (Pelulus)
      </h1>
      <p class="mt-2 text-sm text-gray-600">
        Semak dan luluskan senarai pemohon bantuan yang telah disahkan untuk
        kelulusan
      </p>
    </div>
        ...
        >
          <div>
            ...
            <span class="text-sm text-gray-500">
              Pilih pemohon yang layak untuk diluluskan
            </span>
          </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                  Klik "Luluskan Senarai" untuk meneruskan pemohon yang dipilih
                  ke peringkat kelulusan
                </p>
              </div>
    ...
    >
      <div class="space-y-4">
        <div class="text-center">
          ...
          <p class="mt-2 text-sm text-gray-500">
            Anda akan meluluskan {{ selectedApplicants.length }} pemohon yang
            dipilih. Adakah anda pasti untuk meneruskan?
          </p>
        </div>
      </div>
      ...
      <template #footer>
        <div class="flex justify-end gap-3">
          ...
          <rs-button variant="primary" @click="confirmApprove">
            Sahkan
          </rs-button>
        </div>
      </template>
...
const breadcrumb = ref([
  ...
  {
    name: "Senarai Pemohon Bantuan (Pelulus)",
    type: "current",
    path: "/BF-BTN/PB/BP/01",
  },
]);
...
// Modify handleApprove to show confirmation modal
const handleApprove = () => {
...
// Add new method for confirmation
const confirmApprove = () => {
  // TODO: Implement approval logic
  // 1. Update status to "Diluluskan"
  // 2. Save to database
