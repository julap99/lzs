          ...
          <FormKit type="form" :actions="false" @submit="handleSubmit">
            ...
            <div v-if="currentStep === 1">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                  v-if="formData.personalInfo.paymentMethod === 'tunai'"
                  class="md:col-span-2"
                >
                  <FormKit
                    type="select"
            ...
            <div v-if="currentStep === 2">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                  v-if="
                    formData.healthInfo.status === 'sakit' ||
                    formData.healthInfo.status === 'cacat'
                  "
                  class="md:col-span-2"
                >
                  <FormKit
                ...
                <div
                  v-if="formData.healthInfo.status === 'sakit'"
                  class="md:col-span-2"
                >
                  <FormKit
                    type="file"
                ...
                <div
                  v-if="formData.healthInfo.status === 'cacat'"
                  class="md:col-span-2"
                >
                  <FormKit
                    type="file"
            ...
            <div v-if="currentStep === 5">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                  v-if="formData.employmentInfo.status === 'bekerja'"
                  class="md:col-span-2"
                >
                  <FormKit
                    type="text"
                ...
                <div
                  v-if="formData.employmentInfo.status === 'tidak-bekerja'"
                  class="md:col-span-2"
                >
                  <FormKit
                    type="textarea"
                ...
                <div
                  v-if="formData.employmentInfo.sector"
                  class="md:col-span-2"
                >
                  <FormKit
                    type="text"
            ...
            <div v-if="currentStep === 6">
              ...
              >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div
                    v-if="dependent.healthStatus === 'kronik'"
                    class="md:col-span-2"
                  >
                    <FormKit
                      type="file"
                  ...
                  <div
                    v-if="dependent.healthStatus === 'cacat'"
                    class="md:col-span-2"
                  >
                    <FormKit
                      type="file"
...
const breadcrumb = ref([
  ...
  {
    name: "Pendaftaran Ringkas",
    type: "current",
    path: "/BF-ADN/PA/DA/quick-registration",
  },
]);
