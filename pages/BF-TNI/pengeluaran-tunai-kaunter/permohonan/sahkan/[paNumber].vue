          ...
          <template #body>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <span class="ml-2">{{ formatDate(withdrawalInfo.withdrawalDate) }}</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span class="ml-2">{{ withdrawalInfo.withdrawalLocation }}</span>
              </div>
            </div>
          </template>
        </rs-card>
        ...
        >
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <FormKit
              ...
              label="Masa Agihan"
              :disabled="true"
              :value="new Date().toLocaleTimeString('ms-MY', { hour: '2-digit', minute: '2-digit' })"
            />
            <FormKit
              type="text"
          ...
          <div class="mb-6">
            ...
            <ul class="list-disc list-inside text-sm text-gray-600">
              <li>Pemohon perlu hadir ke lokasi agihan pada tarikh dan masa yang ditetapkan</li>
...
onMounted(async () => {
  try {
    ...
    if (withdrawalInfo.value && btbInfo.value) {
      ...
      formData.value.disbursementTime = new Date().toLocaleTimeString('ms-MY', { hour: '2-digit', minute: '2-digit' });
      formData.value.disbursementLocation = withdrawalInfo.value.withdrawalLocation;
