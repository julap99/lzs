  ...
  <div class="container mx-auto px-4 py-6">
    <div class="mb-8">
      ...
      <p class="text-gray-600">
        Documentation for calendar inputs and search field standards
      </p>
    </div>
    ...
    <div class="mb-12">
      ...
      <div class="mb-8">
        <h3 class="text-lg font-medium text-gray-700 mb-4">
          5.4.1 Calendar Display and Layout
        </h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-white rounded-lg shadow-sm p-4">
            <div class="mb-3">
              ...
              <p class="text-xs text-gray-500 mb-3">
                Displays current month with today highlighted
              </p>
            </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-4">
            <div class="mb-3">
              ...
              <p class="text-xs text-gray-500 mb-3">
                Past dates are disabled (future-only selection)
              </p>
            </div>
            <div class="form-control">
          ...
          <div class="bg-white rounded-lg shadow-sm p-4">
            <div class="mb-3">
              ...
              <p class="text-xs text-gray-500 mb-3">
                Weekend dates (Saturday & Sunday) are disabled
              </p>
            </div>
            <div class="form-control">
              ...
              <div class="text-xs text-gray-500 mt-1">
                (HTML date inputs don't support disabling specific dates)
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-4">
            <div class="mb-3">
              ...
              <p class="text-xs text-gray-500 mb-3">
                Calendar displaying validation error
              </p>
            </div>
            <div class="form-control">
              <label class="form-label">Pilih Tarikh</label>
      ...
      <div class="mb-8">
        <h3 class="text-lg font-medium text-gray-700 mb-4">
          5.4.2 Start and End Date Usage
        </h3>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          <div class="mb-4">
            ...
            <p class="text-xs text-gray-500 mb-3">
              End date is restricted based on start date selection
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="form-control">
              ...
              <div v-if="!startDate" class="text-xs text-gray-500 mt-1">
                Sila pilih tarikh mula terlebih dahulu
              </div>
            </div>
          </div>
          ...
          <div class="mt-6">
            <div class="mb-3">
              <h4 class="text-sm font-semibold text-gray-600">
                Invalid Date Range Example
              </h4>
              <p class="text-xs text-gray-500 mb-2">
                Demonstrates error state when end date precedes start date
              </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="form-control">
                ...
                <input
                  type="text"
                  :value="
                    endDate ? new Date(endDate).toLocaleDateString('ms-MY') : ''
                  "
            ...
            <div class="mt-4 flex space-x-2">
              <button
                ...
                class="px-3 py-1.5 bg-red-100 text-red-600 rounded-md text-sm"
              >
                Tunjuk Ralat Julat
              </button>
              <button
                @click="resetCalendars"
                class="px-3 py-1.5 bg-gray-100 text-gray-600 rounded-md text-sm"
              >
                Set Semula
              </button>
            </div>
      ...
      <div class="mb-8">
        <h3 class="text-lg font-medium text-gray-700 mb-4">
          5.4.3 Visual States and Responsiveness
        </h3>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          <div class="mb-4">
            ...
            <p class="text-xs text-gray-500 mb-3">
              Different visual states for calendar inputs
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="form-control">
              ...
              />
              <div class="text-xs text-gray-500 mt-1">
                Placeholder visible, no value selected
              </div>
            </div>
            ...
            <div class="form-control">
              ...
              />
              <div class="text-xs text-gray-500 mt-1">
                Input is disabled, no interaction
              </div>
            </div>
            ...
            <div class="form-control">
              ...
              />
              <div class="text-xs text-gray-500 mt-1">
                Input is focused, calendar would open
              </div>
            </div>
            ...
            <div class="form-control">
              ...
              <div
                class="border border-dashed border-gray-300 rounded-md p-3 bg-gray-50 text-center"
              >
                <div class="text-sm text-gray-500 mb-2">
                  Sistem kalendar natif
                </div>
                <svg
                ...
                <div class="text-xs text-gray-500 mt-2">
                  Paparan modal penuh skrin pada peranti mudah alih
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="mb-12">
      <div class="border-b border-gray-200 pb-2 mb-6">
        <h2 class="text-xl font-semibold text-gray-800">
          5.5 Search Field Behavior Standards
        </h2>
      </div>
      ...
      <div class="mb-8">
        <h3 class="text-lg font-medium text-gray-700 mb-4">
          5.5.1 Controlled Input Trigger
        </h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-white rounded-lg shadow-sm p-4">
            <div class="mb-3">
              ...
              <p class="text-xs text-gray-500 mb-3">
                Search executed only on button click
              </p>
            </div>
            <div class="flex">
              <input
            ...
            <div class="text-xs text-gray-500 mt-2">
              Carian hanya dilaksanakan apabila butang diklik
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-4">
            <div class="mb-3">
              ...
              <p class="text-xs text-gray-500 mb-3">
                Auto-triggers after 3 characters with 300ms debounce
              </p>
            </div>
            <div class="relative">
              <div class="flex">
              ...
              <div v-else class="text-xs text-gray-500 mt-1">
                Carian bermula selepas 3 aksara dimasukkan
              </div>
            </div>
            ...
            <div
              ...
              class="mt-4 border rounded-md divide-y"
            >
              <div
            ...
            <div
              ...
              class="mt-4 p-3 text-center bg-gray-50 rounded-md"
            >
              <Icon
            ...
            >
              <div class="animate-pulse">
                <div
                  class="h-4 bg-gray-200 rounded-full mb-2.5 w-3/4 mx-auto"
                ></div>
                <div
                  class="h-3 bg-gray-200 rounded-full mb-2.5 w-1/2 mx-auto"
                ></div>
      ...
      <div class="mb-8">
        <h3 class="text-lg font-medium text-gray-700 mb-4">
          5.5.2 Pattern Matching and Validation
        </h3>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          <div class="mb-4">
            ...
            <p class="text-xs text-gray-500 mb-3">
              Pattern matching and validation for search inputs
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="form-control border border-gray-200 rounded-md p-3">
              ...
              <div class="text-red-500 text-xs mt-1">
                Hanya aksara abjad angka dan tanda sempang dibenarkan
              </div>
            </div>

            <!-- Valid Search Examples -->
            <div
              class="form-control border border-gray-200 rounded-md p-3 col-span-1 md:col-span-2"
            >
              <h5 class="text-sm font-medium text-gray-600 mb-2">
                Contoh Carian Sah
              </h5>
              <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                  ...
                  <div
                    class="border border-gray-300 rounded-md px-3 py-2 bg-gray-50 text-sm"
                  >
                    Ahmad bin Hassan
                  </div>
                </div>
      ...
      <div class="mb-8">
        <h3 class="text-lg font-medium text-gray-700 mb-4">
          5.5.3 Interface Feedback and UX
        </h3>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          <div class="mb-4">
            ...
            <p class="text-xs text-gray-500 mb-3">
              Visual feedback for different search states
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Results State -->
            <div
              class="border border-gray-200 rounded-md p-3 col-span-1 md:col-span-2"
            >
              <h5 class="text-sm font-medium text-gray-600 mb-2">
                Results Display
              </h5>
