<template>
  <div>
    ...
    <rs-card>
      <template #header
        >Terima & Sahkan Penerimaan Tunai (Cawangan/Amil/Operasi
        Daerah)</template
      >
      <template #body>
    ...
    >
      <template #body>
        ...
        <div class="bg-gray-50 p-4 rounded-lg">
          ...
          <p class="font-medium">Jenis Lokasi: {{ formData.jenisLokasi }}</p>
          <p class="font-medium">
            Nama Pegawai Penerima: {{ formData.namaPegawaiPenerima }}
          </p>
          <p class="font-medium">
            Jumlah Tunai Diterima: RM
            {{ formData.jumlahTunaiDiterima || "0.00" }}
          </p>
...
const breadcrumb = ref([
  ...
  {
    name: "Terima & Sahkan Penerimaan Tunai (Cawangan/Amil/Operasi Daerah)",
    type: "current",
    path: "/BF-PTPC/PC/BE/04",
  },
]);
...
const jenisLokasiOptions = [
  ...
  {
    label: "Cawangan, Amil & Operasi Daerah (di HQ Menara Zakat)",
    value: "HQ",
  },
];
