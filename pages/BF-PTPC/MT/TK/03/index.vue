        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="md:col-span-2">
              ...
              <p class="font-medium">
                Proses mengira baki tunai fizikal di setiap kaunter pada akhir operasi
                harian, dan mengesahkan jumlah closing bagi setiap EKP. Pengesahan
                dilakukan dengan memadankan jumlah fizikal dengan rekod transaksi dalam
                sistem NAS.
              </p>
            </div>
            <div>
